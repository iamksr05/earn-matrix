...
/**
 * Add / Switch to GoChain Testnet
 */
export async function addGoChainNetwork() {
  ...
  try {
    ...
    console.error("Failed to add GoChain testnet:", err);
    alert("Network setup failed: " + err.message);
  }
}
