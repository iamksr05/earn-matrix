...
--
-- ⚠️ IMPORTANT: This assumes the tasks table already exists!
-- If you get "relation tasks does not exist" error, run:
-- supabase/migrations/complete_setup.sql (creates table + adds Flare fields)
-- OR
-- supabase/migrations/001_create_tasks_table.sql (creates table first)
